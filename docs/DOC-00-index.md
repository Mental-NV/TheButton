...
- Start with [**DOC-01**](DOC-01-agent-instructions.md) and [**DOC-02**](DOC-02-goals-constraints-non-goals.md).
- Use [**DOC-03**](DOC-03-architecture-overview.md) as the reference for layering, folder structure, and CQRS style (no MediatR).
- Use [**DOC-04**](DOC-04-api-contract.md) and [**DOC-05**](DOC-05-persistence-design.md) as the source of truth for contract + data model.
- Use [**DOC-06**](DOC-06-localdev-and-migrations.md)/[**DOC-07**](DOC-07-integration-testing.md) to implement and verify local and CI behavior.
- Use [**DOC-08**](DOC-08-observability-and-reliability.md) for operational hardening.
- Use [**DOC-09**](DOC-09-definition-of-done.md) for milestone acceptance criteria.

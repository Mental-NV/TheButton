# Add ConnectionStrings:Sql for LocalDB and Azure SQL
...
## Description
Configure appsettings to use ConnectionStrings:Sql; provide local default for (localdb)\\MSSQLLocalDB. AC: local app connects. Refs: DOC-06.

# Add UserIncrement command/handler/result
...
## Description
Implement command/handler for POST /counter/{userId}; result returns globalValue + userValue. Uses Operation=UserIncrement and UserId in idempotency. AC: handler unit-testable. Refs: DOC-04,DOC-05.

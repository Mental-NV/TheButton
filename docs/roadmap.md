...
- [EPIC: Add EF Core persistence with write/read schemas and migrations](backlog/M1/E1-1/EPIC-M1-E1-1-add-ef-core-persistence-with-write-read-schemas-and-migrations.md) **[InReview]**
  - [Add ConnectionStrings:Sql for LocalDB and Azure SQL](backlog/M1/E1-1/TASK-M1-E1-1-add-connectionstrings-sql-for-localdb-and-azure-sql.md) **[InReview]**
  - [Add EF Core SQL Server packages and DbContext skeleton](backlog/M1/E1-1/TASK-M1-E1-1-add-ef-core-sql-server-packages-and-dbcontext-skeleton.md) **[InReview]**
  - [Add migration SQL for read.GlobalCounter view](backlog/M1/E1-1/TASK-M1-E1-1-add-migration-sql-for-read-globalcounter-view.md) **[InReview]**
  - [Create initial migration for schemas/tables/indexes](backlog/M1/E1-1/TASK-M1-E1-1-create-initial-migration-for-schemas-tables-indexes.md) **[InReview]**
  - [Define event schema: CounterIncremented with optional UserId](backlog/M1/E1-1/TASK-M1-E1-1-define-event-schema-counterincremented-with-optional-userid.md) **[InReview]**
  - [Define idempotency schema scoped by operation and user](backlog/M1/E1-1/TASK-M1-E1-1-define-idempotency-schema-scoped-by-operation-and-user.md) **[InReview]**
  - [Dev-only auto-migrate on startup (optional)](backlog/M1/E1-1/TASK-M1-E1-1-dev-only-auto-migrate-on-startup-optional.md) **[InReview]**
  - [Map entities for write.Events/write.Commands/read.UserCounters](backlog/M1/E1-1/TASK-M1-E1-1-map-entities-for-write-events-write-commands-read-usercounters.md) **[InReview]**
  - [Update DOC-05 to reflect optional userId + idempotency scoping](backlog/M1/E1-1/TASK-M1-E1-1-update-doc-05-to-reflect-optional-userid-idempotency-scoping.md) **[InReview]**
...
- [EPIC: Implement v3 counter write endpoints (atomic + idempotent)](backlog/M2/E2-1/EPIC-M2-E2-1-implement-v3-counter-write-endpoints-atomic-idempotent.md) **[New]**
  - [Add GlobalIncrement command/handler/result](backlog/M2/E2-1/TASK-M2-E2-1-add-globalincrement-command-handler-result.md) **[New]**
  - [Add Minimal API endpoint POST /api/v3/counter/{userId}](backlog/M2/E2-1/TASK-M2-E2-1-add-minimal-api-endpoint-post-api-v3-counter-userid.md) **[New]**
  - [Add Minimal API endpoint POST /api/v3/counter](backlog/M2/E2-1/TASK-M2-E2-1-add-minimal-api-endpoint-post-api-v3-counter.md) **[New]**

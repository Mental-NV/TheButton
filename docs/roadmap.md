...
- [EPIC: Observability and health](backlog/M5/E5-1/EPIC-M5-E5-1-observability-and-health.md) **[Done]**
...
- [EPIC: Documentation updates (README + examples)](backlog/M6/E6-1/EPIC-M6-E6-1-documentation-updates-readme-examples.md) **[Done]**
  - [README: API examples (curl) for v3 endpoints](backlog/M6/E6-1/TASK-M6-E6-1-readme-api-examples-curl-for-v3-endpoints.md) **[Done]**
  - [README: LocalDB + migrations + scripts section](backlog/M6/E6-1/TASK-M6-E6-1-readme-localdb-migrations-scripts-section.md) **[Done]**
  - [Update roadmap and ADR references after v3 contract change](backlog/M6/E6-1/TASK-M6-E6-1-update-roadmap-and-adr-references-after-v3-contract-change.md) **[Done]**

...
[![CI - Backend & Web](https://github.com/Mental-NV/TheButton/actions/workflows/ci-backend.yml/badge.svg)](https://github.com/Mental-NV/TheButton/actions/workflows/ci-backend.yml)
...
-   `src/mobile/TheButton.MockApi`: Mock API for mobile development and E2E
...
-   **CI - Backend & Web**: Validates API and Web projects. Optimized for speed by skipping MAUI workloads.
-   **CI - Mobile**: Validates mobile projects and runs mobile unit/integration tests.
-   **Mobile E2E**: Triggers on mobile-related changes. Runs Maestro E2E tests on Android and iOS.
-   **Deploy**: Triggers after successful `CI - Backend & Web` run on `main`. Deploys API and Web components to Azure.
